...
title: "Just Say No"
slug: "just-say-no"
date: 2022-11-29T16:32:40+00:00
drupal:
  nid: 3258
  path: /blog/2022/just-say-no
...
{{< figure src="./005-no-no-no.png" alt="No No No" width="700" height="394" class="insert-image" >}}
...
{{< figure src="./006-okay-to-say-no.png" alt="It's okay to say no" width="700" height="394" class="insert-image" >}}
...
{{< figure src="./007-gh-issues.png" alt="GitHub issues geerlingguy" width="700" height="394" class="insert-image" >}}
...
{{< figure src="./008-baseball-kids.png" alt="Baseball bat kid hitting" width="700" height="394" class="insert-image" >}}
...
Back then I wrote [this](/blog/2016/why-i-close-prs-oss-project-maintainer-notes):
...
{{< figure src="./011-jeff-diapers.png" alt="Jeff holding bag of diapers" width="700" height="394" class="insert-image" >}}

A year and a few thousand diapers later, I talked about burnout [at DrupalCon Baltimore](/blog/2017/dont-drown-your-open-source-project).
...
I was still a bit optimistic about how much I could take on. That session had a pretty positive vibe: we're all human, we all have our own struggles, we're all in this together, so if you _have_ to say no, try to say it nicely and let people down lightly...

{{< figure src="./013-surgery.png" alt="Jeff after surgery hospital bed" width="700" height="394" class="insert-image" >}}
...
And just before the pandemic started, [I wrote this](/blog/2020/saying-no-burnout-open-source-maintainer):
...
{{< figure src="./015-jeff-presenting-raspberry-pis.png" alt="Jeff Geerling presenting on Raspberry Pis" width="700" height="394" class="insert-image" >}}

I've always wanted to teach. I was even close to being an adjunct professor at a local university a few years back. But making that work while providing for a family _and_ dealing with chronic illness would've been difficult.
...
I wrote [that blog post](/blog/2020/saying-no-burnout-open-source-maintainer) just a few days before starting my first YouTube livestream, migrating my Drupal 7 website to Drupal 8. I've always enjoyed sharing my open source work, and this was a new and unique way to do it.

{{< figure src="./017-youtube-livestream.png" alt="YouTube livestream Ansible 101 series Jeff Geerling" width="700" height="394" class="insert-image" >}}

Also a bit stressful, but it was the first real taste I had of _educating_ on YouTube. So I spent an hour a week live-streaming the upgrade process, and then something huge happened:

The pandemic.

Suddenly thousands of developers were sent home during lockdown, and a _many_ people had a _lot of_ time on their hands.

So I decided to take a risk. Using time I freed up by my adoption of 'No', I devoted a few hours a week to prepping a new livestream series, [Ansible 101](https://www.jeffgeerling.com/blog/2020/ansible-101-jeff-geerling-youtube-streaming-series). That series fed into [another series on Kubernetes](https://kube101.jeffgeerling.com), and the rest is history.

{{< figure src="./019-youtube-stats.png" alt="YouTube stats Jeff Geerling" width="700" height="394" class="insert-image" >}}
...
{{< figure src="./020-jeff-green-screen.png" alt="Jeff with rackmount server in front of green screen" width="700" height="394" class="insert-image" >}}
...
{{< figure src="./021-practical-advice.png" alt="Practical advice to prevent burnout for open source" width="700" height="394" class="insert-image" >}}
...
That's why we choose open source licenses. It says, basically, you can use my code. But it's not a support contract. It's not a retainer. For _me_, I usually provide the most liberal license, MIT, even though it's not the most 'purist' license out there. I do that because I encourage people to fork my projects.
...
But I'll repeat what I wrote in my [most recent post on burnout](/blog/2022/burden-open-source-maintainer) from January:
...
I enabled the Stale Bot because it was an admission of this fact: _Unless I specifically mark an issue as a bug or being 'planned' in my roadmap_, it's just not that important to me.

Note that I never _lock_ an issue. There are millions of old, closed GitHub issues with tons of useful information. And I encourage people to work through things in an issue, regardless of its status. But for me, maybe I'm just crazy, but when I hop over to one of my own open source projects, and see a thousand open issues? That's not motivating.
...
And I'm not the only one hammering out this message. Just a couple weeks ago, [Mike McQuaid wrote this](https://mikemcquaid.com/entitlement-in-open-source/):
...
And if that's not enough, I just noticed a post by Connor Tumbleson on [Open Source &amp; Saying "No"](https://connortumbleson.com/2022/11/28/open-source-saying-no/).

No is powerful, it gives you focus, it gives you freedom. And it might just be the thing that prevents you from burning out.

To anyone who doesn't like it, remind them that if you don't say No _now_, there's a good chance there won't even _be an opportunity_ for a Yes later, if you're burned out!

---

_The above post is a version of the talk I gave to open source developers at GitHub Nova 2022._
