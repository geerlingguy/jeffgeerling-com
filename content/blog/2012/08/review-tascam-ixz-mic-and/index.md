...
date: 2012-08-31T14:43:16+00:00
drupal:
  nid: 1245
  path: /review/audio-and-video/review-tascam-ixz-mic-and
...
<blockquote class="tldr"><strong>tl;dr</strong>: Likely the best interface for the iPhone headset jack, especially when considering the price. Hardware could use some improvement, but it works pretty well.</blockquote>

<p style="text-align: center;">{{< figure src="./tascam-ixz_0.jpg" alt="Tascam iXZ Audio Interface by Jeff Geerling" width="500" height="355" class="blog-image" >}}</p>

When I first heard about the <a href="http://www.amazon.com/gp/product/B005NZ05J8/ref=as_li_ss_tl?ie=UTF8&amp;camp=1789&amp;creative=390957&amp;creativeASIN=B005NZ05J8&amp;linkCode=as2&amp;tag=mmjjg-20">Tascam iXZ</a>, I was excited to try it out; it has a two-in-one input jack, with both XLR and 1/4" plugs, a stereo headphone jack, input level adjustment, an off/guitar/mic-level selector, and even built-in phantom power for condenser and powered mics. Kind of a swiss army knife of TRRS input adapters!
...
<em>See my article on <strong><a href="/articles/photography/iphone-4-ipad-external-mic-audio-input">External Microphones and inputs for iPhone, iPod Touch, and iPad</a></strong> for more information.</em>

<h3>Build Quality and Features</h3>
...
<h4>Combo Plug and Mic/Line Level selection</h4>
...
This means that if I want to use something like my favorite little lavaliere, the <a href="http://www.amazon.com/gp/product/B002HJ9PTO/ref=as_li_ss_tl?ie=UTF8&amp;camp=1789&amp;creative=390957&amp;creativeASIN=B002HJ9PTO&amp;linkCode=as2&amp;tag=mmjjg-20">Audio Technica ATR-3350</a>, with this interface, I need to also use a male XLR to female 1/4" adapter, as well as a 1/4" male to 1/8" female adapter—quite unwieldy!
...
As it stands, the iXZ works great with many of my mics and inputs, including a <a href="http://www.amazon.com/gp/product/B000CZ0R42/ref=as_li_ss_tl?ie=UTF8&amp;camp=1789&amp;creative=390957&amp;creativeASIN=B000CZ0R42&amp;linkCode=as2&amp;tag=mmjjg-20">Shure SM58</a>, a line-level acoustic guitar, and a line-level input adapted from a stereo mixer output.

<h3>Audio Quality</h3>

The audio coming through the iXZ is about as good as you can get through the iPhone's headset plug. You can definitely get a little better quality/range if you buy a dock-adapter-based audio interface like the <a href="/review/audio-and-video/guitarjack-model-2-audio-inter">GuitarJack Model 2</a> or the <a href="/review/audio-and-video/fostex-ar-4i-iphone-4-stereo-a">Fostex AR-4i</a>, but those solutions cost a bit more.
...
<ul>
	<li><a href="./tascam-ixz-iphone-fire.aif">iPhone - Field Audio Recorder</a> (1.6 MB AIFF)</li>
	<li><a href="./tascam-ixz-iphone-voice-memos.m4a">iPhone - Voice Memos</a> (112 KB M4A)</li>
	<li><a href="./tascam-ixz-macbook-quicktime.m4a">MacBook Air - QuickTime*</a> (382 KB M4A)</li>
</ul>
...
<a href="http://www.amazon.com/gp/product/B005NZ05J8/ref=as_li_ss_tl?ie=UTF8&amp;camp=1789&amp;creative=390957&amp;creativeASIN=B005NZ05J8&amp;linkCode=as2&amp;tag=mmjjg-20">Buy the Tascam iXZ</a> on Amazon for about <span itemprop="price">$30</span>.

<a href="http://www.amazon.com/review/R1WJYZM23CLY2M/?tag=mmjjg-20">Read my review on Amazon.com »</a>
