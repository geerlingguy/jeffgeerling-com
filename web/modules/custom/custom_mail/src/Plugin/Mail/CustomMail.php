...
namespace Drupal\custom_mail\Plugin\Mail;
...
/**
 * Defines custom Drupal mail backend, using PHP's native mail() function.
 *
 * @Mail(
 *   id = "custom_mail",
 ...
 * )
 */
class CustomMail implements MailInterface {
